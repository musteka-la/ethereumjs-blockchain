...
var DBManager = /** @class */ (function () {
    ...
    DBManager.prototype.getHeads = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(util_1.headsKey, { valueEncoding: 'json' })];
            });
        });
    };
    /**
    ...
    DBManager.prototype.getHeadHeader = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(util_1.headHeaderKey)];
            });
        });
    };
    /**
    ...
    DBManager.prototype.getHeadBlock = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(util_1.headBlockKey)];
            });
        });
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._db.get(key, opts)];
                    case 1:
                        value = (_a.sent());
                        if (value && opts.cache) {
    ...
    DBManager.prototype.batch = function (ops) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._db.batch(ops)];
            });
        });
    };
    return DBManager;
